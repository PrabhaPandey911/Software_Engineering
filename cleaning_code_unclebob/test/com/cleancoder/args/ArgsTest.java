...
public class ArgsTest {
  ...
  @Test
  public void testManyMissingStringArrayElement() throws Exception {
    try {
      Args args = new Args("x[*]", new String[] {"-x", "alpha", "-x", "beta", "-x"});
      assertTrue(args.has('x'));
      String[] result = args.getStringArray('x');
  ...
  public void testMissingMapMessage() throws Exception {
    try{
      ...
      assertEquals(MISSING_MAP,e.getErrorCode());
      assertEquals('x', e.getErrorArgumentId());
    }
  }
  ...
  @Test
  public void testFourMapArgument() throws Exception {
    Args args = new Args("f&", new String[] {"-f", "key1:val1,key2:val2,key3:val3,key4:val4"});
    assertTrue(args.has('f'));
    Map<String, String> map = args.getMap('f');
